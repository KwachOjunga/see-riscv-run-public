...
- Trap fundamentals (exception vs interrupt)
- Trap entry and exit flow
- CSR updates (xepc, xcause, xtval, xstatus)
- Exception handling (illegal instruction, page fault, ECALL)
- Interrupt architecture (software, timer, external)
- PLIC (Platform-Level Interrupt Controller)
- CLIC (Core-Local Interrupt Controller)
- AIA (Advanced Interrupt Architecture)
- Comparison with ARM GIC
